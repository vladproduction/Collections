...
import com.vladproduction.map.MyMapImpl2;

import java.util.Arrays;

public class MyMapImpl2Test {
    ...
    public void hasCode_equals_Test() {
        ...
        MyMap map1 = new MyMapImpl2();
        map1.put("zidane", 5);
        map1.put("costa", 10);
        map1.put("figo", 8);

        //hashCode == ; equals.
        Assert.assertFalse(map == map1);//by objects
        Assert.assertTrue(map.hashCode() == map1.hashCode()); //by inside
